 ...
 *  - open the .nd2 file and save as tiff the three channels separately (C0-Phase contract & C1- fluorescent channel & C2- fluorescent channel)
...
only_PC=0 // for single channel phase contrast image sequences use the ImageJ macro 1_split_image.ijm with setting 1
