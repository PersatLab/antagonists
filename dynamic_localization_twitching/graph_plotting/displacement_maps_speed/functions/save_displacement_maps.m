...
dir_data_input='C:\directory\graph_plotting\'; %  directory of the Data_Input_Graph_Plotting.xlsx file
dir_data='G:\directory\'; % directory of the data processed by 1_split_image.ijm and BacStalk basic analysis
dir_func='C:\directory\'; % directory of the Functions folder, note capital F, same folder as for basic analysis
save_dir = strcat(save_dir,'mat_files\'); % directory for saving the mat files
