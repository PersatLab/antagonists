...
% !!! displacement maps only works with 3 replicates max !!!
% disable if more than 3, only speed plot works with more than 3
...
save_dir = 'G:\directory\displacement_maps_speed\'; % directory for saving the plots, must contain "mat_files", "svg_files", "fig_files" folder
...
tos = "2h"; % just the title of the displacement maps graph
...
% activate plots as desired
plot_speed_cut = 0; % Note, plots speed of tracked-frame-thresholded tracks! same subset of cells that is used for displacement maps
